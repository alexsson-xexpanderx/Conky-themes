...
The animated 3D variant that started life here has moved to its own folder, <a href="../Conky_Orrery">Conky_Orrery</a>, and has its own README there. It reads the same sensors and shares this theme's hwmon and scaling code, but it is a different enough thing to live on its own - and it ships a small editor for changing its colours with a live preview.

<a href="../Conky_Orrery"><img src="../Conky_Orrery/screenshot.png" width="420"></a>
